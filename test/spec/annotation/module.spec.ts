...
import { Module, Container, DiErrorCode, Injectable, CLL_MODULE, getModuleMeta } from "../../../src";
...
describe("Annotation - Module(): define modular dependency injection", () => {
  ...
  it("can be detected as cellularjs module", () => {
    // client can use Reflect.getMetadata to verify it is cellularjs module
    expect(Reflect.getMetadata(CLL_MODULE, JwtModule)).to.exist;
    
    // or client can use getModuleMeta to verify it is cellularjs module
